...
### 30.01.2026
    - '.env' angelegt und mittels 'grep' in das Bash-Script als Variable geladen (Variable wird nach curl gelöscht)
    - API mit neuer 'check_token' Funktion ausgestattet. Diese prüft den 'Authorization Header' gegen den geladenen Token
    - im 'Post /uptime' Endpoint wird 'check_token' über 'Depends' eingebunden und schützt so den Schreibzugriff
### 28.01.2026
